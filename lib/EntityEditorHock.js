            ...
            _createClass(EntityEditorHock, [{
                ...
                value: function componentWillReceiveProps(nextProps) {
                    ...
                    if (workflowTask && this.props.workflow.task !== nextProps.workflow.task) {
                        ...
                        var taskFunction = workflowTask.get('onEnter'); // TODO remove references to "operate" in favour of "onEnter"
                        if (taskFunction) {
                ...
                value: function entityEditorProps(promptProps) {
                    ...
                    var task = this.props.workflow.task;
                    ...
                    var pending = {}; // TODOthis.pendingProps(config) REMOVE THIS
