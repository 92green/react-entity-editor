...
var _ModalContainer = require('./modal/ModalContainer');
    ...
    return function (ComposedComponent) {
        var EntityEditorHock = function (_Component) {
            ...
            _createClass(EntityEditorHock, [{
                ...
                key: 'operate',
                value: function operate(operateFunction, nextWorkflow, props) {
                ...
                value: function partiallyApplyOperations(operations, props) {
                    ...
                    operations.forEach(function (operation, key) {
                        ...
                        var operationProps = (0, _immutable.Map)(_extends({}, additional, {
                            ...
                            setEditorState: _this4.setEditorState()
                        })).filter(function (ii) {
                            return ii;
                        }).toObject();
                ...
                value: function entityEditorProps(promptProps) {
                    ...
                    var workflowTask = userConfig.getWorkflowTask(task, name);
                    var promptAsProps = !!workflowTask && workflowTask.get('type') == "prompt" && workflowTask.get('style') == "props";

                    var prompt = promptAsProps && workflowTask ? workflowTask.get('prompt')(promptProps) : null;

                    var pending = {}; // TODOthis.pendingProps(config)
