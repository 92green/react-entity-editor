        ...
        var EntityEditorHock = function (_Component) {
            ...
            _createClass(EntityEditorHock, [{
                ...
                value: function operate(operateFunction, props) {
                    ...
                    var originalOperations = config.get('operations');
                    ...
                    (0, _Utils.returnPromise)(result).then(this.onOperationSuccess(actionProps), this.onOperationError(actionProps));
                }
            }, {
                ...
                value: function isCurrentTaskBlocking() {
                    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.props;
                ...
                value: function entityEditorProps(statusProps) {
                    ...
                    var abilities = config.get('actions', (0, _immutable.Map)()).map(function (actionConfig, actionName) {
                        return !_this6.isCurrentTaskBlocking();
                    }).toObject();
                    ...
                    var status = statusAsProps && currentWorkflow ? currentWorkflow.get('status')(statusProps) : null;
