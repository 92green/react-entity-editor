    ...
    return function (Component) {
        ...
        return _temp = _class = function (_React$Component) {
            ...
            this.startTask = function (props) {
                ...
                if (skip) {
                    var skipProps = {
                        editorState: _this6.getState(props).editor
                    };
                    var skipTo = skip(skipProps);
                    if (skipTo && typeof skipTo == "string") {
                        _this6.getWorkflow(props).next(skipTo);
                        return;
                    }
                }
                ...
                if (operationName) {
                    _this6.operate(operationName, props);
                }
            };
            ...
            this.operate = function (operationName, props) {
                ...
                if (currentTask && currentTask.get('preSuccess')) {
                    _this6.onOperationSuccess(actionProps, _this6.props, props)();
            ...
            this.onOperationSuccess = function (_ref2, prevProps, thisProps) {
                var onSuccess = _ref2.onSuccess;

                return function (result) {
                    var prevWorkflow = _this6.getWorkflow(prevProps);
                    var thisWorkflow = _this6.getWorkflow(thisProps || _this6.props);
