    ...
    return function (ComposedComponent) {
        var EntityEditorHock = function (_Component) {
            ...
            _createClass(EntityEditorHock, [{
                ...
                key: 'setPending',
                value: function setPending(actionName, pending) {
                    this.setState({
                        pending: Object.assign({}, this.state.pending, _defineProperty({}, actionName, pending))
                    });
                }
            }, {
                key: 'openPrompt',
                ...
                key: 'getSuccessAction',
                value: function getSuccessAction(config, actionName) {
                ...
                value: function wrapActionWithPrompts(config, action, actionName, actionProps) {
                    ...
                    var beginPending = function beginPending(actionProps) {
                        _this4.setPending(actionName, true);
                        return actionProps;
                    };

                    var endPendingSuccess = function endPendingSuccess(result) {
                        _this4.setPending(actionName, false);
                        return result;
                    };
                    ...
                    var doSuccessAction = this.getSuccessAction(config, actionName);
                    ...
                    return this.getPromptPromise(config, 'confirm', actionName, actionProps).then(callOnConfirm).then(beginPending).then(function (actionProps) {
