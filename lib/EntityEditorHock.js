...
exports.default = function () {
    ...
    var preloadActionIds = userConfig.preloadActionIds,
        ...
        _userConfig$promptCom = userConfig.promptComponent,
        promptComponent = _userConfig$promptCom === undefined ? function (props) {
        ...
        var EntityEditorHock = function (_Component) {
            ...
            _createClass(EntityEditorHock, [{
                ...
                value: function renderPrompt() {
                    ...
                    return _react2.default.cloneElement(promptComponent(this.props), _extends({}, prompt, {
                        open: promptOpen && !promptAsProps,
                        onRequestClose: this.closePrompt.bind(this),
                        message: Message && _react2.default.createElement(Message, prompt.item)
                    }));
                }
            }, {
                key: 'render',
