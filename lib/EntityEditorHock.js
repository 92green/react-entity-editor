        ...
        var EntityEditorHock = function (_Component) {
            ...
            _createClass(EntityEditorHock, [{
                ...
                value: function componentWillReceiveProps(nextProps) {
                    ...
                    var workflowTask = userConfig.getWorkflowTask(task, name);
                    ...
                    if (workflowTask && this.props.workflow.task !== nextProps.workflow.task) {
                        ...
                        var taskType = workflowTask.get('type');
                        if (taskType == "operate") {
                ...
                value: function pendingProps(config) {
                    ...
                    return function (id) {
                        return config.get('actions').map(function (action, actionName) {
                            return _this3.getPending(id, actionName);
                        }).toObject();
                    };
                }
                ...
                key: 'operate',
                value: function operate(operateFunction, nextWorkflow) {
                    ...
                    var partiallyAppliedOperations = this.partiallyApplyOperations(originalOperations);
                ...
                value: function partiallyApplyOperations(operations) {
                    var _this4 = this;
                    ...
                    operations.forEach(function (operation, key) {
                        ...
                        var operationProps = (0, _immutable.Map)({
                            operations: mutableOperations,
                            setEditorState: _this4.setEditorState() // TODO is this named correctly?
                        }).filter(function (ii) {
                            return ii;
                        }).toObject();
                ...
                value: function onOperationSuccess(_ref) {
                    ...
                    return function (result) {
                        ...
                        return _this5.props.workflow.next("onSuccess", _this5.props.workflow.end);
                    };
                }
            }, {
                ...
                value: function onOperationError(_ref2) {
                    ...
                    return function (result) {
                        ...
                        return _this6.props.workflow.next("onError", _this6.props.workflow.end);
                    };
                }
                ...
                value: function renderPrompt() {
                    ...
                    var prompt = promptOpen && workflowTask ? workflowTask.get('prompt') : null;
                ...
                value: function entityEditorProps() {
                    ...
                    var actions = userConfig.get('actions', (0, _immutable.Map)()).map(function (actionConfig, actionName) {
                        return function (actionProps) {
                            ...
                            _this7.workflowStart(actionName, actionConfig, actionProps);
                        };
                    }).toJS();
                ...
                value: function render() {
                    var props = _extends({}, this.props, _defineProperty({}, entityEditorProp, this.entityEditorProps()));
