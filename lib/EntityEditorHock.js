        ...
        var EntityEditorHock = function (_Component) {
            ...
            _createClass(EntityEditorHock, [{
                ...
                value: function getPreparedConfig(config) {
                    ...
                    var actionConfigFilter = (0, _immutable.fromJS)(['actions', 'callbacks', 'successActions', 'confirmPrompts', 'successPrompts', 'errorPrompts', 'promptDefaults']);
                    ...
                    return (0, _immutable.fromJS)(config).set('callbacks', callbacks).filter(function (ii, name) {
                        return actionConfigFilter.includes(name);
                    }).toJS();
                }
            }, {
