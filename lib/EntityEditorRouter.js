...
function createEditorRoutes(params) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouter.Route, { path: 'new', component: wrapItemComponent({ paramId: paramId })(itemComponent) }),
        _react2.default.createElement(_reactRouter.Route, { path: ':' + paramId + '/edit', component: wrapItemComponent({ paramId: paramId })(itemComponent) })
    );
}
