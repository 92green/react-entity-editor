...
var BaseConfig = (0, _EntityEditorConfig2.default)({
    ...
    tasks: {
        ...
        deleteOperate: {
            onEnter: function onEnter(_ref10) {
        ...
        goOperate: {
            onEnter: function onEnter(_ref15) {
        ...
        dirtyOperate: {
            onEnter: function onEnter(_ref16) {
    ...
    operations: {
        onDirty: function onDirty(_ref17) {
            var setEditorState = _ref17.setEditorState;
            return function (actionProps) {
