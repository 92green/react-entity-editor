...
var baseConfig = exports.baseConfig = {
    ...
    callbacks: {
        onCreate: function onCreate(config) {
    ...
    confirmPrompts: {
        ...
        go: {
            showWhen: function showWhen(_ref11) {
                var dirty = _ref11.dirty;
                return dirty;
            },
