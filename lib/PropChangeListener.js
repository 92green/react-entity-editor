...
exports.default = function (propKeys, outputFunction) {
    return function (ComposedComponent) {
        return function (_Component) {
            _inherits(PropChangeListener, _Component);

            function PropChangeListener(props, context) {
                _classCallCheck(this, PropChangeListener);

                return _possibleConstructorReturn(this, (PropChangeListener.__proto__ || Object.getPrototypeOf(PropChangeListener)).call(this, props, context));
            }

            _createClass(PropChangeListener, [{
